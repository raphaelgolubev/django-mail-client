...
class IMAPService:
    ...
    async def __connect_imap(self) -> aioimaplib.IMAP4_SSL | None:
        ...
        if response.result == 'OK':
            ...
            raise Exception(f"Login failed: {self.email=} {self.password=} {response.result}")
    ...
    async def get_message(self, id: str):
        ...
        if raw_email:
            ...
            return IMAPService.Message(id, subject, date_sent, date_received, content, attachments)
